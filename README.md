...
| **人工复核** | PDF 原文 120 DPI 渲染后逐页视觉比对 | 38 处修正已合入 |

本册的完整复核流程是：把标准 PDF 按 120 DPI 全本渲染成图 → 逐页人工比对机器提取结果 → 修正后重跑 v2.1 与 V1–V7 两套审计。38 处修正涵盖文本回源、参数名与单位精修、适用范围回填、误抽排除项清理。

> 提醒：这里的「0 违规」指**结构层面的机器校验**，不等于内容语义零差错。涉及工程决策前请回源核对纸质/官方版本。
